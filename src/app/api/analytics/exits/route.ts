...
import { getDepartmentActivity } from "@/server/modules/analytics/analytics.service";
...
export const GET = withErrorHandling(async (req: NextRequest) => {
  ...
  const departmentActivity = await getDepartmentActivity();
  return NextResponse.json({ success: true, departmentActivity });
});
